...
namespace HomeBudgetManager.Core
{
    public class TransactionService
    {
        ...
        public List<DBFinancialOperations> SomeUserTransactions(int userId, int amount, AppDbContext db)
        {
                // POPRAWKA: t.EmployeeId
            ...
            foreach (var rule in recurringRules)
            {
                ...
                {
                    if (transaction.Id == rule.TransactionPatternId) //Matches regarding IDs
                    {
